...
function isAdminAuthenticated() {
  ...
  return !!localStorage.getItem("token") && (role === "ADMIN" || role === "ROLE_ADMIN");
}

function isStudentAuthenticated() {
  const role = localStorage.getItem("role");
  return !!localStorage.getItem("token") && (role === "STUDENT" || role === "ROLE_STUDENT");
}

function isInstructorAuthenticated() {
  const role = localStorage.getItem("role");
  return !!localStorage.getItem("token") && (role === "INSTRUCTOR" || role === "ROLE_INSTRUCTOR");
}
