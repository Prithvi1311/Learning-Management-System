            ...
            >
              ...
              <div className="flex-1 text-left">
                <h3 className="text-lg font-bold text-neutral mb-1 max-md:text-sm">
                  {(course.course_name || "Untitled").length < 8
                    ? `${course.course_name || "Untitled"} Tutorial`
              ...
              <Link to={`/course/${course.course_id}`} className="ml-3">
                <button className={`px-4 py-2 rounded-lg text-sm font-semibold transition max-md:px-2 max-md:py-1 max-md:text-[10px] ${course.completed
